...
var textAssistantHelper = {
  ...
  getAnswerMcq: async function (question) {
    var prompt = `Please provide a concise answer to the multiple choice question without any additional explanation. Please answer in a structured way to enhance readability. Present the answer in a clear and coherent manner, formatted as an HTML string suitable for display on a website. Use appropriate HTML tags like <p>, <strong>, and <em> to highlight key aspects and ensure readability.Provide the output as plain text without any additional formatting or code blocks. The question is : ${question}`;
    const result = await model.generateContent(prompt);
